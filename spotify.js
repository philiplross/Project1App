                ...
                app.getArists = (artist) => $.ajax({
                  ...
                  method: 'GET',
                  dataType: 'json',
                  //headers: 'auth token you get from spotify
                  // https://github.com/spotify/web-api-auth-examples/blob/master/authorization_code/app.js#L76
                  // redirect-uri is your localhost server address
                  data: {
                    type: 'artist',
                    q: artist
                  }
